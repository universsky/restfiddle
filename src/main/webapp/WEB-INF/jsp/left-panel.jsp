...
<div class="col-xs-2 sidebar rf-col-1">
	<div id="rf-col-1-body">
		...
		<div class="rf-margin-5">
			<h6 class="rf-h6">测试项目&nbsp;&nbsp;</h6>
			<button class="btn btn-default btn-xs pull-right rf-btn-margin-2"
		...
		<br>
		<div>
			<h6 class="rf-h6 members-width">历史</h6>
		</div>
		<ul class="nav nav-pills nav-stacked rf-left-nav">
			<li class="list-view-menu-item starred"><a href="#/starred"><span
					class="glyphicon glyphicon-star"></span>&nbsp;&nbsp;Starred</a></li>
			<li class="list-view-menu-item history"><a href="#/activityLog"><span
					class="glyphicon glyphicon-time"></span>&nbsp;&nbsp;Activity Log </a></li>
			<li><a href="#" data-toggle="modal"
				data-target="#globalSettingsModal"> <span
		...
		<br>
		<div>
			<h6 class="rf-h6 members-width">项目成员</h6>
			<button class="btn btn-default btn-xs pull-right rf-btn-margin-2"
				id="manageCollaboratorsMenu" data-toggle="modal"
				data-target="#manageCollaboratorsModal">
				<span class="glyphicon glyphicon-plus rf-plus-font"></span>
			</button>
		</div>
