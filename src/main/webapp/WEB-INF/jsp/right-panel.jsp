...
<div class="col-xs-6 rf-col-3">
	<div id="projectRunnerSection">
		<div id="projectRunnerHeader">
			<br>
			<button class="btn btn-primary btn-sm" id="exportRunProjectReport">导出报告</button>
			<br> <br>
		</div>
		<div id="loading">
			加载中 <i class="fa fa-cog fa-spin" title="Loading"></i>
		</div>
		<div>
	...
	<div id="webSocketSection">
		...
		<div id="webSocketRequest">
			...
			<p>
				<span id="socketName">Socket名称</span><input
					id="socketNameTextBox">
			</p>
			<p>
			...
			<br>
			<p>
				<input type="text" class="form-control" id="secketUrl"
			...
			<br>
			<p>
				<textarea id="socketMessage" class="form-control"
		...
		<div id="webSocketResponse">
			...
			<div id="webSocketResponseBody"></div>
		</div>
	</div>
	<div class="form-group" id="conversationSection">
		<div id="conversationHeader">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					<li><a href="#" class="btn-sm" data-toggle="modal"
						data-target="#comingSoon">保存并运行</a></li>
				</ul>
			</div>
			&nbsp;&nbsp;
			<div class="btn-group">
				<button type="button" class="btn btn-default btn-sm"
					data-toggle="modal" id="saveConversationBtn">保存</button>
				...
				<ul class="dropdown-menu">
					<li><a href="#" class="btn-sm" data-toggle="modal"
						id="saveAsConversationBtn">保存</a></li>
				</ul>
			</div>
			&nbsp;&nbsp;
			<div class="btn-group">
				<button type="button" class="btn btn-default btn-sm"
					data-toggle="modal" data-target="#assertsModal" id="manageAsserts">
					断言 <span id="assertCount" class="badge">0</span>
				</button>
				<button type="button" class="btn btn-default btn-sm dropdown-toggle"
					data-toggle="dropdown">
					<span class="caret"></span> <span class="sr-only">Toggle
				...
				<ul class="dropdown-menu">
					<li><a href="#" class="btn-sm" id="showLastResponse">查看上一次结果</a></li>
				</ul>
			</div>
			&nbsp;&nbsp;
			<div class="btn-group">
				<button type="button" class="btn btn-default btn-sm"
					id="clearRequest">重置</button>
				<button type="button" class="btn btn-default btn-sm dropdown-toggle"
					data-toggle="dropdown">
					<span class="caret"></span> <span class="sr-only">Toggle
						Dropdown</span>
				...
				<ul class="dropdown-menu">
					<li><a href="#" class="btn-sm" id="clearBody">清空 Body</a></li>
					<li><a href="#" class="btn-sm" id="clearHeader">清空 Header</a></li>
					<li><a href="#" class="btn-sm" id="clearCookie">清空 Cookie</a></li>
					<li><a href="#" class="btn-sm" id="clearAuth">清空 Auth</a></li>
				</ul>
			</div>
			&nbsp;&nbsp;
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					<li class="copyResponseList"><a href="#" class="btn-sm"
						id="copyResponse" data-toggle="tooltip" data-placement="top"
						data-container="body" title=""
						data-original-title="Copy the response content.">复制响应</a></li>
					<li><a href="#" class="btn-sm" id="showLastResponse">最近一次响应</a></li>
				</ul>
			</div>
			&nbsp;&nbsp;&nbsp;
			...
			<button
				class="btn btn-default btn-sm pull-right right-pannel-toggle-btn"
			...
			<div>
				<div>
					<p class="apiRequestContainer">
						<input type="hidden" id="apiReqNodeId"> <input
							type="hidden" id="rfRequestId"> <span id="requestToggle"
				...
				<div id="requestContainer">
					...
					<div class="btn-group label-btn-group">
						...
						<button type="button"
							...
							data-toggle="dropdown">
							<span class="glyphicon glyphicon-tags"></span> &nbsp;标签&nbsp;<span
						...
						<div class="row">
							...
							<div class="col-xs-10 rf-col-xs-10-padding">
								<input type="text" class="form-control typeahead" id="apiUrl"
									placeholder="Enter URL"> <input type="hidden"
									id="evaluatedApiUrl"> <br> <br>
							</div>
						</div>
					</div>
					...
					<div class="tab-content reponse-pannel">
						...
						<div class="tab-pane" id="tab-form">
							...
							<p>
								<button type="button" class="btn btn-default btn-sm"
									id="addFormDataBtn">Add Form Data</button>
							</p>
							<div id="formDataWrapper"></div>
						</div>
						...
						<div class="tab-pane" id="tab-file">
							...
							<p>
								<button type="button" class="btn btn-default btn-sm"
									id="addFileDataBtn">Add File Data</button>
							</p>
							<div id="fileDataWrapper"></div>
						</div>
						<div class="tab-pane" id="tab-query">
							<br>
							<p>
								<button type="button" class="btn btn-default btn-sm"
									id="addQueryParamBtn">Add Query Param</button>
							</p>
							<div id="queryParamsWrapper"></div>
						</div>
						<div class="tab-pane" id="tab-header">
							...
							<p>
								<button type="button" class="btn btn-default btn-sm"
									id="addHeaderBtn">Add Header</button>
							</p>
                    ...
                    -->
						<div class="tab-pane" id="tab-auth">
							...
							<div class="btn-group" data-toggle="buttons"
								...
								<label class="btn btn-primary btn-sm"> <input
									type="radio" name="authOptions" id="option1" value="basic" />
									Basic
								</label> <label class="btn btn-primary btn-sm"> <input
									type="radio" name="authOptions" id="option2" value="digest" />
									Digest
								</label> <label class="btn btn-primary btn-sm"> <input
									type="radio" name="authOptions" id="option3" value="oauth2" />
									OAuth 2
								</label>
							</div>
                        ...
                        <p></p>
							...
							<div class="tab-pane authFields" id="tab-oauth2">
								<span id="fetchedAccessToken"></span> <br>
								<div id="oauth2Wrapper"></div>
								<br>
								<div>
									<input type="text" class="form-control" id="oauthName"
										placeholder="Enter Name">
								</div>
								<br>
								<div>
									<input type="text" class="form-control" id="authorizationUrl"
										placeholder="Enter Authorization Endpoint">
								</div>
								<br>
								<div>
									<input type="text" class="form-control" id="accessTokenUrl"
										placeholder="Enter Access Token Endpoint">
								</div>
								<br>
								<div>
								...
								<br>
								<div>
									<input type="text" class="form-control" id="authScopes"
			...
			<div class="tab-pane" id="res-tab-assert">
				...
				<div class="clearfix">
					...
					<div class="pull-right">
						...
						</span>&nbsp;&nbsp;<span>Size : <span id="content-size"></span>
							Bytes
						</span>
					</div>
					</p>
